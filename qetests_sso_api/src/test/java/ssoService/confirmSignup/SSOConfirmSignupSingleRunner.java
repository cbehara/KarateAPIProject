package ssoService.confirmSignup;
...
@CucumberOptions(features = "classpath:ssoService/confirmSignup/ssoConfirmSignup_Negative.feature")
public class SSOConfirmSignupSingleRunner {
