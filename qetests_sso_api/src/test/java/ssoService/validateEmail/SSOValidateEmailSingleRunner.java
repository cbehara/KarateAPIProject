package ssoService.validateEmail;
...
@CucumberOptions(features = "classpath:ssoService/validateEmail/ssoValidateEmail_Negative.feature")
public class SSOValidateEmailSingleRunner {
