package ssoService.updatePassword;
...
@CucumberOptions(features = "classpath:ssoService/updatePassword/ssoUpdatePassword_Negative.feature")
public class SSOUpdatePasswordSingleRunner {
